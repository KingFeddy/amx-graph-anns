...
int main(int argc, char* argv[]) {
    std::string base_path = argc > 1 ? argv[1] : "/home/kingfeddy/repos/anns_research/sift/sift_base.fvecs";
    std::string query_path = argc > 2 ? argv[2] : "/home/kingfeddy/repos/anns_research/sift/sift_query.fvecs";
